...
def derivative(x, y, data, shape, order):

    """
    Compute the derivatives of a potential field in Fourier domain in the x, y and z directions.
...
def estimate_alpha(x, y, data, shape, alpha, order):
...
def inclination_amplitude_analytical_signal(dx, dy, dz):
